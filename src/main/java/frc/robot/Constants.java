...
public final class Constants {
  ...
  public static boolean useDebuggingBindings = true;
  public static boolean isRedAlliance = DriverStation.getAlliance().isPresent() && DriverStation.getAlliance().get() == Alliance.Red;
