...
public class MoveToPosition {
    ...
    public MoveToPosition(
        ...
        Consumer<ChassisSpeeds> setDesiredStates, Drive requirements, Vision vision) {
    ...
    public Command generateMoveToPositionCommandTimed( Pose2d targetPose, ChassisSpeeds targetChassisSpeeds,
            ...
            // TODO add following code to AK:
            // profiles.getLongestTime(targetPose, targetChassisSpeeds));
    ...
    public Command generateMoveToPositionCommand(
        ...
        return new FunctionalCommand(
            ...
            () -> {
                ...
                // TODO add value to advantage kit
                // controller.atGoal();
